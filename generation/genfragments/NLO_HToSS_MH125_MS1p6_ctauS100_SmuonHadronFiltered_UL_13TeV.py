...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('POWHEG:nFinal = 1', 
            '9000006:all = sk   skbar    0        0          0       1.6  1.9732e-15  1.0  75.0 100',
            '9000006:oneChannel = 2  0.117 101  13 -13',
            '9000006:addChannel = 3  0.039 101  211 -211',
            '9000006:addChannel = 3  0.412 101  321 -321',
            '9000006:addChannel = 3  0.412 101  311 -311',
            '9000006:mayDecay = on',
