...
sed -i "s/step2/step2_$1/g" NLO_HToSSTo2Mu2Hadrons_MH125_MS2_ctauS${ctauS}_TuneCP_13TeV-powheg-pythia8_DR_cfg_$1.py
#sed -i "s/input = cms.untracked.int32(-1)/input = cms.untracked.int32(10)/g" NLO_HToSSTo2Mu2Hadrons_MH125_MS2_ctauS${ctauS}_TuneCP_13TeV-powheg-pythia8_DR_cfg_$1.py
#sed -i "s/nevts:-1/nevts:10/g" NLO_HToSSTo2Mu2Hadrons_MH125_MS2_ctauS${ctauS}_TuneCP_13TeV-powheg-pythia8_DR_cfg_$1.py
