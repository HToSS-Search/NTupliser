...
# with command line options: Configuration/GenProduction/python/HToSSTo2Mu2Hadrons/NLO_HToSSTo2Mu2Hadrons_MH125_MS2_ctauS100_TuneCP_13TeV-powheg-pythia8.py --python_filename NLO_ggHToSS_MH125_MS2_ctau100_SmuonHadronFiltered_2021.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:NLO_ggHToSS_MH125_MS2_ctau100_SmuonHadronFiltered_2021.root --conditions 122X_mcRun3_2021_realistic_v9 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(9)\nprocess.source.numberEventsInLuminosityBlock=cms.untracked.uint32(245) --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HToSSTo2Mu2Hadrons/NLO_HToSSTo2Mu2Hadrons_MH125_MS2_ctauS100_TuneCP_13TeV-powheg-pythia8.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:NLO_ggHToSS_MH125_MS2_ctau100_SmuonHadronFiltered_2021.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:NLO_ggHToSS_MH125_MS2_ctau100_SmuonHadronFiltered_2021_inLHE.root'),
...
process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(245)
