...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/NLO_HToSS_MH125_MS2_ctauS100_SmuonHadronFiltered_2018_13TeV.py nevts:100'),
...
#            <particle id="..." name, antiName, spinType=, chargeType, colType, m0, mWidth, mMin, mMax, tau0> ##tau0 = nominal proper lifetime (mm/c) 
            '9000006:all = sk   skbar    0        0          0       0.8  1.9732e-15  1.0  75.0 100',
