...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/NLO_HToSS_MH125_MS2_ctauS1000_SmuonHadronFiltered_2018_13TeV.py nevts:100'),
...
#            <particle id="..." name, antiName, spinType=, chargeType, colType, m0, mWidth, mMin, mMax, tau0> ##tau0 = nominal proper lifetime (mm/c) 
            '9000006:all = sk   skbar    0        0          0       0.8  1.9732e-16  1.0  75.0 1000',
            '9000006:oneChannel = 2  0.061 101  13 -13',
            '9000006:addChannel = 3  0.626 101  211 -211',
            '9000006:addChannel = 3  0.0   101  321 -321',
            '9000006:addChannel = 3  0.0   101  311 -311',
            '9000006:mayDecay = on',
