...
# with command line options: step2 --mc --eventcontent RAWSIM --outputCommand keep *_mix_*_*,keep *_genPUProtons_*_* --datatier GEN-SIM-RAW --inputCommands keep *,drop *_*_BMTF_*,drop *PixelFEDChannel*_*_*_* --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:25ns15e33_v4 --nThreads 8 --geometry DB:Extended --era Run2_2016 --filein file:step1.root --fileout file:step2.root -n -1
