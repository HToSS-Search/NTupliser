...
# with command line options: Configuration/GenProduction/python/NLO_HToSSTo2Mu2Hadrons_MH125_MS2_ctauS0_TuneCP_13TeV-powheg-pythia8.py --python_filename HToSSTo2Mu2Hadrons_MH125_MS2_ctauS0_TuneCP_13TeV-powheg-pythia8_GS_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:/pnfs/iihe/cms/store/user/sdansana/HToSS/MC/GEN-SIM/NLO_ggH_HToSS_SmuonHadronFiltered_MH125_MS2_ctauS0_2021_220424/step0.root --conditions 120X_mcRun3_2021_realistic_v5 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --customise_commands process.g4SimHits.Physics.G4GeneralProcess = cms.bool(False)\nprocess.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 5000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/NLO_HToSSTo2Mu2Hadrons_MH125_MS2_ctauS0_TuneCP_13TeV-powheg-pythia8.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/pnfs/iihe/cms/store/user/sdansana/HToSS/MC/GEN-SIM/NLO_ggH_HToSS_SmuonHadronFiltered_MH125_MS2_ctauS0_2021_220424/step0.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            'POWHEG:nFinal = 1',
            '9000006:all = sk   skbar    0        0          0       2.0  1.9732e-15  1.0  75.0 0',
