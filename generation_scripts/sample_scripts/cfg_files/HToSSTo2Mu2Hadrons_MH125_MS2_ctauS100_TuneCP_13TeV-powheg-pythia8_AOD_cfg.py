...
# with command line options: --python_filename AOD_cfg.py --eventcontent RECOSIM,AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RECO,AODSIM --fileout file:step3.root --conditions 120X_mcRun3_2021_realistic_v6 --customise_commands process.AODSIMoutput.outputCommands.extend(['keep  *_particleFlowCluster*_*_*', 'keep *_mix_MergedTrackTruth_*', 'keep *_ecalDigis*_*_*', 'keep *_genParticles*_*_*']); process.AODSIMoutput.outputCommands.append('keep *_particleFlowClusterECAL_*_*'); process.AODSIMoutput.outputCommands.append('keep *_mix_MergedTrackTruth_*'); process.AODSIMoutput.outputCommands.append('keep EBDigiCollection_ecalDigis*_*_*'); process.AODSIMoutput.outputCommands.append('keep EEDigiCollection_ecalDigis*_*_*'); process.AODSIMoutput.outputCommands.append('keep *SrFlagsSorted*_ecalDigis*_*_*'); process.AODSIMoutput.outputCommands.append('keep recoGenParticle*_genParticles_*_*') --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:step2.root --era Run3 --no_exec --mc -n 10
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/pnfs/iihe/cms/store/user/sdansana/HToSS/MC/DIGI2RAW/DIGI2RAW_NLO_ggH_HToSS_SmuonHadronFiltered_MH125_MS2_ctauS100_2021_220424/step2.root'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/pnfs/iihe/cms/store/user/sdansana/HToSS/MC/AODSIM/AODSIM_NLO_ggH_HToSS_SmuonHadronFiltered_MH125_MS2_ctauS100_2021_220424/step3.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/pnfs/iihe/cms/store/user/sdansana/HToSS/MC/AODSIM/AODSIM_NLO_ggH_HToSS_SmuonHadronFiltered_MH125_MS2_ctauS100_2021_220424/step3_inAODSIM.root'),
