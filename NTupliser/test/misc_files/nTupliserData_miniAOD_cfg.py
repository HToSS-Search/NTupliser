...
process.makeTopologyNtupleMiniAOD.maxMuonEta=cms.double(2.5)
process.makeTopologyNtupleMiniAOD.minMuonPt1=cms.double(20.0)
process.makeTopologyNtupleMiniAOD.minMuonPt2=cms.double(5.0)
process.makeTopologyNtupleMiniAOD.maxMuonDeltaR = cms.double(1)
...
process.makeTopologyNtupleMiniAOD.hadronType=cms.string("ChargedKaon") # if set to false will skip ALL cuts. Z veto still applies electron cuts.
