...
process.makeTopologyNtupleMiniAOD.Skim=cms.string("HToSS") # if set to false will skip ALL cuts. Z veto still applies electron cuts.
# if ("HToSS" in options.inputFiles[0]): process.makeTopologyNtupleMiniAOD.isggH=cms.bool(True) # this is set to true for signal samples
# else: process.makeTopologyNtupleMiniAOD.isggH=cms.bool(False) # this is set to true for signal samples
process.makeTopologyNtupleMiniAOD.isggH=cms.bool(False) # this is set to true for signal samples; If true, correct the thing below
process.makeTopologyNtupleMiniAOD.hadronType=cms.string("ChargedKaon") # only relevant if ggH
