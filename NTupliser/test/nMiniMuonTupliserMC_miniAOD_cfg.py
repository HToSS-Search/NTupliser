...
#process.makeMiniMuonNtupleMiniAOD.triggerToken = cms.InputTag("TriggerResults","","HLT") # or HLT, depends on file   
...
#process.makeMiniMuonNtupleMiniAOD.genParticles = cms.InputTag("prunedGenParticlesPlus")
#process.makeMiniMuonNtupleMiniAOD.genSimParticles = cms.InputTag("prunedGenParticlesPlus")
