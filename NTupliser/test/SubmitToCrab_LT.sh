...
cp Crab3Config_MC_LT.py crab_template_temp.py
...
cp nTupliser_miniAOD_cfg_LT_reweighting.py theconfig.py
...
sed -ie "s/LIFETIME/$ctaus/g" theconfig.py
sed -ie "s/MASS/$mass/g" theconfig.py
